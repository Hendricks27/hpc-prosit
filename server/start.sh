...
LSF_DOCKER_PORTS='8008:8008' bsub \
  -g /d.goldfarb/compute -G compute-d.goldfarb \
  ...
  -o /storage1/fs1/d.goldfarb/Active/Projects/Wenjin/code/prosit/xtest.%J.log \
  -e /storage1/fs1/d.goldfarb/Active/Projects/Wenjin/code/prosit/xtest.%J.err \
  python3 server.py
